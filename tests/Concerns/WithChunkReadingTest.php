...
class WithChunkReadingTest extends TestCase
{
    ...
    public function can_import_to_model_in_chunks()
    {
        ...
        $this->assertEquals($import->before, 'BeforeImport was not called or called more than once.');
        $this->assertEquals($import->after, 'AfterImport was not called or called more than once.');
    }
